...
大きく5つに分けます。最初にJevの役割と設計、次に速度と費用、その後に判断精度と型保証、既知の弱点、最後に実用例という順です。速度の節では、業務用途だけでなく、DOOMなどのリアルタイム・ゲーム用途と日本からの実測も確認します。
...
最後に利用箇所を見ます。共通する条件は、答えの候補や評価軸をあらかじめ限定でき、その判断結果を次のコードやエージェント処理がすぐ使えることです。ゲーム用途でも、この条件は同じです。
...
もう一つの軸は第三者検証です。日本やアジアからのレイテンシ、特にゲームなどリアルタイム用途での実効値、accuracyやcalibration、実際のagentやRAGでの利用例を増やしていきます。ベンダー自身の主張と、外部から再現された結果を混ぜないことを、この調査の基本ルールにします。
